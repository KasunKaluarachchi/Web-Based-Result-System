		...
		if(isset($_POST['updatebtn1'.$i.'']))
	    {
	    	if(isset($_POST['check-all'.$i.'']))
	    	{
               ...
               $f =$_POST['id'.$i.''];
                ...
                $query ="UPDATE course_2s SET sub_id ='$f', sub_name='$l'  WHERE no ='$r'";
	   
	             $result =mysql_query($query);
	             if(!$result)
	             {
	             
	             	 echo "<script type='text/javascript'>alert('Update failed');window.location = \"Add_Course_details_2.php\"</script>";
	             }
	             else
	             {
	             	 echo "<script type='text/javascript'>alert('Update successfully');window.location = \"Add_Course_details_2.php\"</script>";   	
			...
			echo "<script type='text/javascript'>alert('Select the check box');window.location = \"Add_Course_details_2.php\"</script>";
	    ...
	    if(isset($_POST['deletebtn1'.$i.'']))
	    {
	    	if(isset($_POST['check-all'.$i.'']))
	    	{
                $f =$_POST['id'.$i.''];
                 ...
                 $query ="DELETE FROM course_2s WHERE sub_id ='".$f."'";
	   
	             $result =mysql_query($query);
	             if($result)
	             {
	                echo "<script type='text/javascript'>alert('Delete successfully');window.location = \"Add_Course_details_2.php\"</script>";
	             ...
	             else
	             {
	             	...
	             	echo "<script type='text/javascript'>alert('Delete is faild');window.location = \"Add_Course_details_2.php\"</script>";
...
echo "<td>";
	...
	$r =$_POST['txtln'];
        ...
        else
        {
        	...
        	$query ="INSERT INTO course_2s (sub_id, sub_name) VALUES ('$f','$r' )";
	   
	        $result =mysql_query($query);
	         if(!$result)
	             {
	          
	             	echo "<script type='text/javascript'>alert('Insert is faild');window.location = \"Add_Course_details_2.php\"</script>";
	             ...
	             else
	             {
	             	...
	             	echo "<script type='text/javascript'>alert('Insert successfully');window.location = \"Add_Course_details_2.php\"</script>";
		...
		if(isset($_POST['updatebtn'.$i.'']))
	    {
	    	if(isset($_POST['check-all'.$i.'']))
	    	{
               ...
               $f =$_POST['id'.$i.''];
                ...
                $query ="UPDATE course_2g SET sub_id ='$f', sub_name='$l'  WHERE no ='$r'";
	    ...
	    if(isset($_POST['deletebtn'.$i.'']))
	    {
	    	if(isset($_POST['check-all'.$i.'']))
	    	{
                $f =$_POST['id'.$i.''];
                 ...
                 $query ="DELETE FROM course_2g WHERE sub_id ='".$f."'";
...
echo "<td>";
	...
	$r =$_POST['txtln'];
        ...
        else
        {
        	...
        	$query ="INSERT INTO course_2g (sub_id, sub_name) VALUES ('$f','$r' )";
