								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="table-header">
											Evalution Method details with respect to format type
...
include('db_config.php');
	...
	$query ="SELECT `custom_id`, `srt_format` FROM `dis_method`";
...
<table id="simple-table" class="table  table-bordered table-hover">
											<thead>
  <tr>
   <th width="20"> <div align="center">Format Type</div></th>
   <th width="200"> <div align="center">Consideration Pattern</div></th>
...
while($query_row =mysql_fetch_array($result))
   {
	 ...
	 if($query_row['custom_id']=='1')
	 {
		
		 
		 echo "<td>";
	   echo '<input type="text" value ="Default" name ="fn1'.$i.'"/>';
	   echo "</td>";
	 }
	...
	{
		echo "<td>";
	   echo '<input type="text" value ="Custom Design" name ="fn1'.$i.'"/>';
	   echo "</td>";
	}

	   echo "<td>";
	   echo '<input type="text" size="100" value ="'.$query_row['srt_format'].'" name ="fn'.$i.'"/>';
	   echo "</td>";
	    ...
	    if(isset($_POST['deletebtn'.$i.'']))
	    {
	    	if(isset($_POST['check-all'.$i.'']))
	    	{
                $f =$_POST['fn'.$i.''];
                 ...
                 $query ="DELETE FROM dis_method WHERE srt_format ='".$f."' ";
	   
	             $result =mysql_query($query);
	             if($result)
	             {
	                echo "<script type='text/javascript'>alert('Delete successfully');window.location = \"dept_hd_view_method.php\"</script>";
	             ...
	             else
	             {
	             	...
	             	echo "<script type='text/javascript'>alert('Delete is faild');window.location = \"dept_hd_view_method.php\"</script>";
