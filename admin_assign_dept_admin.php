							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Faculty Name </label>

										<div class="col-sm-9">
											
										<?php
										
										echo '<input type ="hidden" id="form-field-1" name = "txtfn" class="col-xs-10 col-sm-5"  />';
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Dean of the Faculty</label>
