...
?>
<form class="form-horizontal" id="sample-form" action="dept_hd_custom32_validate1.php" method="post">
...
<table id="simple-table" class="table  table-bordered table-hover">
  ...
  <tr>
   ...
   <th width="10"> <div align="center">Per instance weight</div></th>
...
<table id="simple-table" class="table  table-bordered table-hover">
  ...
  <tr>
   ...
   <th width="100"> <div align="center">Evaluation object</div></th>
   <th width="8"> <div align="center">No: of instances per object</div></th>
     <th width="8"> <div align="center">No: of instances to be consider</div></th>
   <th width="8"> <div align="center">Per instance weight</div></th>
    <input type="hidden" name="myHiddenValue" value="<?php 
	 $id1=$_GET['prop_id'];
$loc=$id1[2];
$num=(int)$loc;
	...
	echo $num ?>" />
       ...
       <input type="hidden" name="myHiddenValue1" value="<?php 
   $id2=$_GET['prop_id'];
$loc1=$id2[16];
$num1=(int)$loc1;
	echo $num1 ?>" />
...
global $num1;
  ...
  {	  
   ...
   echo "<td>";
	...
	echo '<input type ="hidden" name ="'.$i.'"><select name="fn1'.$i.'">';
	...
	echo "<td>";
    echo '<input type ="text" name ="txt_lec1'.$j.'"/>';
    echo "</td>";
$j++;
	...
	echo "<td>";
    echo '<input type ="text" name ="txt_year1'.$k.'"/>';
    echo "</td>";
	$k++;
	
	echo "<td>";
    echo '<input type ="text" name ="txt_year12'.$l.'"/>';
    echo "</td>";
	$l++;
