			...
			<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
				...
				<ul class="nav nav-list">
					...
					<li class="active open">
						<a href="Add_Student_details_tables.php" class="dropdown-toggle">
	...
	if($_POST["hdnCmd"] == "Add")
{
	...
	$strSQL = "INSERT INTO add_student ";
...
if($_GET["Action"] == "Del")
{
	$strSQL = "DELETE FROM add_student ";
...
$strSQL = "SELECT * FROM add_student";
...
<table id="dynamic-table" class="table table-striped table-bordered table-hover">
  ...
  <tr>
    ...
    <th width="19"> <div align="center">Title </div></th>
	<th width="98"> <div align="center">Student Name</div></th>
    <span class="green">
...
?>
  ...
  <tr>
	...
	<td><?php echo $objResult["stu_name"];?></td>
...
?>
  <tr>
    ...
    <td><input type="text" name="txtAddcoursename" size="8" ></td>
    <td><input type="text" name="txtAddlevel" size="2"></td>
	<td><input type="text" name="txtAddlevel" size="50"></td>
