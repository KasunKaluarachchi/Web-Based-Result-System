...
<table id="simple-table" class="table  table-bordered table-hover">
  ...
  <tr>
   ...
   <th width="100"> <div align="center">Course ID</div></th>
   <th width="1000"> <div align="center">Course Name</div></th>
    <span class="green">
...
echo "<td>";
	   ...
	   echo "<td>";
	   echo '<input type="text" size="50" value ="'.$query_row['sub_name'].'" name ="na'.$i.'"/>';
	   echo "</td>";
		...
		if(isset($_POST['updatebtn1'.$i.'']))
	    {
	    	if(isset($_POST['check-all'.$i.'']))
	    	{
               ...
               $f =$_POST['id'.$i.''];
                ...
                $query ="UPDATE course_1s SET sub_id ='$f', sub_name='$l'  WHERE no ='$r'";
	   
	             $result =mysql_query($query);
	             if(!$result)
	             {
	             
	             	 echo "<script type='text/javascript'>alert('Update failed');window.location = \"Add_Course_details_1.php\"</script>";
	             }
	             else
	             {
	             	 echo "<script type='text/javascript'>alert('Update successfully');window.location = \"Add_Course_details_1.php\"</script>";   	
			...
			echo "<script type='text/javascript'>alert('Select the check box');window.location = \"Add_Course_details_1.php\"</script>";
	    ...
	    if(isset($_POST['deletebtn1'.$i.'']))
	    {
	    	if(isset($_POST['check-all'.$i.'']))
	    	{
                $f =$_POST['id'.$i.''];
                 ...
                 $query ="DELETE FROM course_1s WHERE sub_id ='".$f."'";
	   
	             $result =mysql_query($query);
	             if($result)
	             {
	                echo "<script type='text/javascript'>alert('Delete successfully');window.location = \"Add_Course_details_1.php\"</script>";
	             ...
	             else
	             {
	             	...
	             	echo "<script type='text/javascript'>alert('Delete is faild');window.location = \"Add_Course_details_1.php\"</script>";
...
echo "<td>";
    echo '<input  type ="text" size="50"  name = "txtln"/>';
    echo "</td>";
	...
	$r =$_POST['txtln'];
        ...
        else
        {
        	...
        	$query ="INSERT INTO course_1s (sub_id, sub_name) VALUES ('$f','$r' )";
	   
	        $result =mysql_query($query);
	         if(!$result)
	             {
	          
	             	echo "<script type='text/javascript'>alert('Insert is faild');window.location = \"Add_Course_details_1.php\"</script>";
	             ...
	             else
	             {
	             	...
	             	echo "<script type='text/javascript'>alert('Insert successfully');window.location = \"Add_Course_details_1.php\"</script>";
		...
		if(isset($_POST['updatebtn'.$i.'']))
	    {
	    	if(isset($_POST['check-all'.$i.'']))
	    	{
               ...
               $f =$_POST['id'.$i.''];
                ...
                $query ="UPDATE course_1g SET sub_id ='$f', sub_name='$l'  WHERE no ='$r'";
	    ...
	    if(isset($_POST['deletebtn'.$i.'']))
	    {
	    	if(isset($_POST['check-all'.$i.'']))
	    	{
                $f =$_POST['id'.$i.''];
                 ...
                 $query ="DELETE FROM course_1g WHERE sub_id ='".$f."'";
...
echo "<td>";
    echo '<input size="50" maxlength="50" type ="text" name = "txtln"/>';
    echo "</td>";
	...
	$r =$_POST['txtln'];
        ...
        else
        {
        	...
        	$query ="INSERT INTO course_1g (sub_id, sub_name) VALUES ('$f','$r' )";
