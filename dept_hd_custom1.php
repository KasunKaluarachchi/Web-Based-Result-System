					...
					<div class="page-content">
						...
						<!-- /.page-header -->
							...
							<small>
									...
									<h4>* Method -1.</h4>
									<h5>&nbsp;&nbsp;&nbsp;Select method 1 - when you consider all evaluation object instances for marking process.<br>
									<br></h5>
									<h4>* Method -2</h4>
									<h5>&nbsp;&nbsp;&nbsp;Select method 2 - when you consider all evaluation object instances of some kind
									and consider some object instances with maximum marks of some kind.<br>
									&nbsp;&nbsp;&nbsp;or<br>
									&nbsp;&nbsp;&nbsp;When considering object instances with maximum marks of some kind.<br>
									<br>
									</h5>
						...
						<form class="form-horizontal" id="sample-form" action="dept_hd_custom1_validate.php" method="post">
												...
												<div class="radio">
													<label>
													<input type="radio" name="check" id="check" class="ace" value="1"> 
														
														<span class="lbl"> Method 1</span>
													</label>
												</div>

												<div class="radio">
													<label>
													<input type="radio" name="check" id="check" class="ace" value="2">
