...
<table id="simple-table" class="table  table-bordered table-hover">
  ...
  <tr>
   ...
   <th width="100"> <div align="center">Academic Year</div></th>
   
    <span class="green">
	<th width="201"> <div align="center"><a class="red" href="#"></a>Add 1st Year Details </div></th>
	<th width="20"> <div align="center"><a class="red" href="#"></a> View Details</div></th>
	<th width="201"> <div align="center"><a class="red" href="#"></a>Add 2nd Year Details </div></th>
	<th width="20"> <div align="center"><a class="red" href="#"></a> View Details</div></th>
	<th width="201"> <div align="center"><a class="red" href="#"></a>Add 3rd Year Details </div></th>
	<th width="20"> <div align="center"><a class="red" href="#"></a> View Details</div></th>
	<th width="201"> <div align="center"><a class="red" href="#"></a>Add 4th Year Details </div></th>
	<th width="20"> <div align="center"><a class="red" href="#"></a> View Details</div></th>
...
while($query_row =mysql_fetch_array($result))
   {
	  ...
	  /*  echo "<td>";
	   echo '<input type="text" value ="'.$query_row['year'].'" name ="fn'.$i.'" readonly/>';
	   echo "</td>"; */
	   echo "<td>";
		echo'<button class="btn btn-white btn-info btn-bold" type ="submit"  name ="addbtn" >
											...
											echo'<button class="btn btn-sm btn-primary" type ="submit" name ="addbtn">
												Upload
