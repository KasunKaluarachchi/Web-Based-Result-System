...
<body>
    ...
    $query = mysql_query("SELECT * FROM uni_admin WHERE username='$username' and password='$password'");
     if (mysql_num_rows($query) != 0)
    {
     echo "<script language='javascript' type='text/javascript'> location.href='admin_index.php' </script>";   
      }
      else
      {
