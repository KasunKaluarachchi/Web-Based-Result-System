				...
				<ul class="nav nav-list">
					...
					<li >
						<a href="admin_index.php">
							...
							<span class="menu-text">Add Faculties</span>
						</a>
					...
					<li class="active">
						<a href="admin_assign_dept_admin.php">
							
							<span class="menu-text">Assign Faculty admins</span>
						</a>

						<b class="arrow"></b>
					</li>
					<li class="">
						<a href="admin_add_head.php">
							
							<span class="menu-text">View Faculty admins</span>
						</a>

						<b class="arrow"></b>
					</li>
					<li class="">
						<a href="admin_resign_head.php">
							
							<span class="menu-text">Resign Faculty admins</span><br>
...
$query ="SELECT 
				faculty_admin.fac_admin_name,
				faculty_admin.from,
				faculty_admin.to,
				faculty_admin.username,
				faculty_admin.password,
				faculty_admin.email,
				faculty_admin.mobile,
				faculty_admin.access,
				faculty.fac_name AS fac_name FROM faculty_admin JOIN faculty ON faculty.fac_id=faculty_admin.fac_id ";
...
<table id="simple-table" class="table  table-bordered table-hover">
  ...
  <tr>
   ...
   <th width="20"> <div align="center">Faculty Name</div></th>
    <th width="20"> <div align="center">Head of the Faculty</div></th>
	 <th width="20"> <div align="center">From</div></th>
    <th width="20"> <div align="center">To</div></th>
	...
	<th width="20"> <div align="center">email</div></th>
	 <th width="20"> <div align="center">mobile</div></th>
...
while($query_row =mysql_fetch_array($result))
   {
	   ...
	   echo "<td>";
	   echo '<input type="text" value ="'.$query_row['fac_name'].'" name ="fn'.$i.'"/>';
	   echo "</td>";
	   echo "<td>";
	   echo '<input type="text" value ="'.$query_row['fac_admin_name'].'" name ="fn'.$i.'"/>';
	   echo "</td>";
		echo "<td>";
	   echo '<input type="date" value ="'.$query_row['from'].'" name ="fn'.$i.'"/>';
	   echo "</td>";
	   echo "<td>";
	   echo '<input type="date" value ="'.$query_row['to'].'" name ="fn'.$i.'"/>';
	   echo "</td>";
		echo "<td>";
	   echo '<input type="text" value ="'.$query_row['username'].'" name ="fn'.$i.'"/>';
	   echo "</td>";
	   echo "<td>";
	   echo '<input type="password" value ="'.$query_row['password'].'" name ="fn'.$i.'"/>';
	   echo "</td>";
	   echo "<td>";
	   echo '<input type="text" value ="'.$query_row['email'].'" name ="fn'.$i.'"/>';
	   echo "</td>";
		echo "<td>";
	   echo '<input type="text" value ="'.$query_row['mobile'].'" name ="fn'.$i.'"/>';
	   echo "</td>";
	   echo "<td>";
	   echo '<input type="text" value ="'.$query_row['access'].'" name ="fn'.$i.'"/>';
	   echo "</td>";
...
echo "<td>";
   ...
   echo "<tr>";
	...
	echo "<td>";
    echo '<input type ="date" name = "txtfn"/>';
    echo "</td>";
	...
	echo "<td>";
    echo '<input type ="password" name = "txtfn"/>';
    echo "</td>";
