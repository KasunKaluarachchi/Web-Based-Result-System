					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" id="sample-form" action="dept_hd_custom2_validate1.php" method="post">
														<div class="form-group has-info">
																<label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right"></label>

																<div class="col-xs-12 col-sm-5">
																	<span class="block input-icon input-icon-right">
																		<input type="number" id="inputInfo" name="inputInfo" class="width-100" >
