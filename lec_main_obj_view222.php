...
include('db_config.php');
 ...
 $query="SELECT st_index,attempt,q1,q2,q3,q4,q5,q6,q7,q8 FROM $sub2 WHERE attempt ='P'";
...
<div class="row hidden-print mt-20">
                  <div class="col-xs-12 text-right"><a onclick="javascript:printDiv('table1')" class="btn btn-primary"><i class="fa fa-print"></i> Print</a></div>
                </div><br>
