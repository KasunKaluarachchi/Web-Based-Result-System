...
<?php
 ...
 $query="SELECT st_index,attempt,q1,q2,q3,q4,q5,q6 FROM $sub2";
	   ...
	   echo "</td>";$y++;}
		...
		if(isset($_POST['updatebtn'.$i.'']))
	    {
	    	if(isset($_POST['check-all'.$i.'']))
	    	{
                ...
                $query ="UPDATE $sub2 SET attempt='$at',q1='$q1' ,q2='$q2',q3='$q3',q4='$q4',q5='$q5',q6='$q6' WHERE st_index='$id'";
	   
	             $result =mysql_query($query);
	             if(!$result)
	             {
	             
	             	 echo "<script type='text/javascript'>alert('Update failed');window.location = \"lec_main_obj_add.php\"</script>";
	             }
	             else
	             {
	             	 echo "<script type='text/javascript'>alert('Update successfully');window.location = \"lec_main_obj_add.php\"</script>";   	
	    ...
	    if(isset($_POST['deletebtn'.$i.'']))
	    {
	    	if(isset($_POST['check-all'.$i.'']))
	    	{
	             ...
	             if($result)
	             {
	                echo "<script type='text/javascript'>alert('Delete successfully');window.location = \"lec_main_obj_add.php\"</script>";
	             ...
	             else
	             {
	             	...
	             	echo "<script type='text/javascript'>alert('Delete is faild');window.location = \"lec_main_obj_add.php\"</script>";
	    	...
	    	else
	    	{
	    		...
	    		echo "<script type='text/javascript'>alert('Select the check box');window.location = \"lec_main_obj_add.php\"</script>";
	    	}
...
if($y==8 && $y<=$rw){
    ...
    if(isset($_POST['addbtn']))
    {
	 ...
	 $y=1;
        ...
        {
        	$query ="INSERT INTO $sub2 (st_index,ac_year,attempt,q1,q2,q3,q4,q5,q6) VALUES ('$id','$yr','$attempt','$q1','$q2','$q3','$q4','$q5','$q6')";
	   
	        $result =mysql_query($query);
	         if(!$result)
	             {
	          
	             	echo "<script type='text/javascript'>alert('Insert is faild');window.location = \"lec_main_obj_add.php\"</script>";
	             ...
	             else
	             {
	             	...
	             	echo "<script type='text/javascript'>alert('Insert successfully');window.location = \"lec_main_obj_add.php\"</script>";
