...
<table id="simple-table" class="table  table-bordered table-hover">
  ...
  <tr>
   ...
   <th width="600"> <div align="center">Faculty</div></th>
		...
		if(isset($_POST['updatebtn'.$i.'']))
	    {
	    	if(isset($_POST['check-all'.$i.'']))
	    	{
               ...
               $f =$_POST['fn'.$i.''];
                ...
                $query ="UPDATE faculty SET fac_name ='$f'  WHERE fac_id ='$r'";
	   
	             $result =mysql_query($query);
	             if(!$result)
	             {
	             
	             	 echo "<script type='text/javascript'>alert('Update failed');window.location = \"admin_index.php\"</script>";
	             }
	             else
	             {
	             	 echo "<script type='text/javascript'>alert('Update successfully');window.location = \"admin_index.php\"</script>";   	
			...
			echo "<script type='text/javascript'>alert('Select the check box');window.location = \"admin_index.php\"</script>";
