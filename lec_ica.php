...
<table id="dynamic-table" class="table table-striped table-bordered table-hover">
  ...
  <tr>
    ...
    <th width="19"> <div align="center">Index Number</div></th>
	
    
    <th width="19"> <div align="center">ICA-1 Marks</div></th>
	<th width="91"> <div align="center">ICA-2 Marks</div></th>
    <th width="98"> <div align="center">Supplementary-ICA 1 Marks</div></th>
    <th width="19"> <div align="center">Supplementary-ICA 2 Marks</div></th>
	<th width="91"> <div align="center">Mid-ICA1 Marks</div></th>
    <th width="98"> <div align="center">Mid-ICA2 Marks</div></th>
    <th width="19"> <div align="center">Assignmet Total Marks</div></th>
    <span class="green">
    <th width="40"> <div align="center"><a class="green" href="#"><i class="ace-icon fa fa-pencil bigger-130"></i></a> </div></th></span>
    <th width="40"> <div align="center"><a class="red" href="#"><i class="ace-icon fa fa-trash-o bigger-120"></i></a> </div></th>
...
?>
  ...
  <tr>
    ...
    <td><?php echo $objResult["index_no"];?></td>
	 
    
	 <td><?php echo $objResult["ica1"];?></td>
    <td><?php echo $objResult["ica2"];?></td>
	 <td><?php echo $objResult["sica1"];?></td>
    <td><?php echo $objResult["sica2"];?></td>
	 <td><?php echo $objResult["mid1"];?></td>
    <td><?php echo $objResult["mid2"];?></td>
	<td><?php echo $objResult["assignment"];?></td>
