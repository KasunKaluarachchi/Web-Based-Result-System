		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="Add_Academic_year_tables_Copy.php">
					...
					<li class="">
						<a href="Add_Academic_year_tables_Copy3.php">
							<i class="menu-icon fa fa-calendar"></i>
					...
					<li class="">
						<a href="Add_Academic_year_tables_Copy4.php">
							<i class="menu-icon fa fa-calendar"></i>
					...
					<li class="">
						<a href="Add_Academic_year_tables_Copy5.php">
							<i class="menu-icon fa fa-calendar"></i>
					...
					<li class="active">
						<a href="Add_Academic_year_tables_Copy6.php">
							<i class="menu-icon fa fa-calendar"></i>
							<span class="menu-text">Redesign Assign</span><br>
							Faculty admins
						</a>
					...
					<li class="">
						<a href="Add_Academic_year_tables_Copy2.php">
					...
					<!--<li class="">
						<a href="Add_Student_details_tables.php" >
							...
							<span class="menu-text">Assign Dean</span>
						</a>
...
<table id="simple-table" class="table  table-bordered table-hover">
  ...
  <tr>
   ...
   <th width="600"> <div align="center">Faculty ID</div></th>
    <th width="600"> <div align="center">Faculty Name</div></th>
