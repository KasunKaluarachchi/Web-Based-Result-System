				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="dept_hd_evalution.php">
							...
							<span class="menu-text">Add Evalution Object</span><br>
							...
							<div class="col-xs-12">
								...
								<div class="widget-box">
									<div class="widget-header widget-header-blue widget-header-flat">
										<h4 class="widget-title lighter">New Default Format</h4>
											...
											<div id="fuelux-wizard-container">
												<div>
													<ul class="steps">
														<li data-step="1" class="active">
															...
															<span class="title">Total Number of Objects</span>
														</li>

														<li data-step="2">
															<span class="step">2</span>
															<span class="title">Select Method</span>
														</li>
														
																	<li data-step="3">
															<span class="step">3</span>
															<span class="title">Details of Method</span>
														</li>
													

														<li data-step="4">
															<span class="step">4</span>
															<span class="title">Create Default Format</span>
														</li>
													</ul>
												</div>
												...
												<div class="step-content pos-rel">
													<div class="step-pane active" data-step="1">
														<h3 class="lighter block green">Total Number of Objects</h3>
