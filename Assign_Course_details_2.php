...
$query ="SELECT * FROM assign_course_2s";
$result=mysql_query($query);

$query2 ="SELECT sub_id FROM course_2s";
$result2=mysql_query($query2);

$query3 ="SELECT lec_name FROM add_lecturer";
...
echo "<td>";
		...
		if(isset($_POST['updatebtn1'.$i.'']))
	    {
	    	if(isset($_POST['check-all'.$i.'']))
	    	{
               ...
               $f =$_POST['id'.$i.''];
                ...
                $query ="UPDATE assign_course_2s SET sub_id ='$f', lec_name='$l'  WHERE no ='$r'";
	   
	             $result =mysql_query($query);
	             if(!$result)
	             {
	             
	             	 echo "<script type='text/javascript'>alert('Update failed');window.location = \"Assign_Course_details_2.php\"</script>";
	             }
	             else
	             {
	             	 echo "<script type='text/javascript'>alert('Update successfully');window.location = \"Assign_Course_details_2.php\"</script>";   	
			...
			echo "<script type='text/javascript'>alert('Select the check box');window.location = \"Assign_Course_details_2.php\"</script>";
	    ...
	    if(isset($_POST['deletebtn1'.$i.'']))
	    {
	    	if(isset($_POST['check-all'.$i.'']))
	    	{
				$r =$query_row['no'];
                 ...
                 $query ="DELETE FROM assign_course_2s WHERE no ='".$r."'";
	   
	             $result =mysql_query($query);
	             if($result)
	             {
	                echo "<script type='text/javascript'>alert('Delete successfully');window.location = \"Assign_Course_details_2.php\"</script>";
	             ...
	             else
	             {
	             	...
	             	echo "<script type='text/javascript'>alert('Delete is faild');window.location = \"Assign_Course_details_2.php\"</script>";
   ...
   echo "<td>";
    echo '<input type ="hidden" /><select name = "txtfn">';
   
   while($row =mysql_fetch_array($result2))
   {
	   echo"<option>".$row['sub_id']."
   ...
   echo "</td>";
	...
	echo "<td>";
    echo '<input type ="hidden" /><select name = "txtln">';
   
   while($row =mysql_fetch_array($result3))
   {
	   echo"<option>".$row['lec_name']."</option>";
   ...
   echo "</td>";
	...
	echo'$r';
        ...
        else
        {
        	...
        	$query ="INSERT INTO assign_course_2s (sub_id, lec_name) VALUES ('$f','$r' )";
	   
	        $result =mysql_query($query);
	         if(!$result)
	             {
	          
	             	echo "<script type='text/javascript'>alert('Insert is faild');window.location = \"Assign_Course_details_2.php\"</script>";
	             ...
	             else
	             {
	             	...
	             	echo "<script type='text/javascript'>alert('Insert successfully');window.location = \"Assign_Course_details_2.php\"</script>";
...
$query ="SELECT * FROM assign_course_2g";
$result=mysql_query($query);
$i =0;
		...
		if(isset($_POST['updatebtn'.$i.'']))
	    {
	    	if(isset($_POST['check-all'.$i.'']))
	    	{
               ...
               $f =$_POST['id'.$i.''];
                ...
                $query ="UPDATE assign_course_2g SET sub_id ='$f', lec_name='$l'  WHERE no ='$r'";
	    ...
	    if(isset($_POST['deletebtn'.$i.'']))
	    {
	    	if(isset($_POST['check-all'.$i.'']))
	    	{
                $f =$_POST['id'.$i.''];
                 ...
                 $query ="DELETE FROM assign_course_2g WHERE sub_id ='".$f."'";
...
echo "<td>";
	...
	$r =$_POST['txtln'];
        ...
        else
        {
        	...
        	$query ="INSERT INTO assign_course_2g (sub_id, lec_name) VALUES ('$f','$r' )";
