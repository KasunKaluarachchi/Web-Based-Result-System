...
$query ="SELECT * FROM ac_year WHERE ac_year.dep_id=(SELECT signup.dep_id FROM signup WHERE signup.username='".$_SESSION['sess_username']."') ";
$result=mysql_query($query);
$i =0;


$query2 = "SELECT signup.dep_id FROM signup WHERE signup.username='$user1'";
$result2=mysql_query($query2);
while($query2_row =mysql_fetch_array($result2))
{
	$user_id = $query2_row['dep_id'];
}
...
<table id="simple-table" class="table  table-bordered table-hover">
  ...
  <tr>
   ...
   <th width="600"> <div align="center">Academic Year</div></th>
...
echo "<td>";
		...
		if(isset($_POST['updatebtn'.$i.'']))
	    {
               ...
               $f =$_POST['fn'.$i.''];
				...
				$query = "UPDATE `ac_year` SET `year`='$f' WHERE id ='$r'";
	             ...
	             if(!$result)
	             {
	             	 ...
	             	 echo "<script type='text/javascript'>alert('Update failed');window.location = \"dept_hd_academic_year.php\"</script>";
	             }
	             else
	             {
	             	echo "<script type='text/javascript'>alert('Update successfully');window.location = \"dept_hd_academic_year.php\"</script>";   	
			...
			echo "<script type='text/javascript'>alert('Select the check box');window.location = \"dept_hd_academic_year.php\"</script>";
	    ...
	    if(isset($_POST['deletebtn'.$i.'']))
	    {
	    	if(isset($_POST['check-all'.$i.'']))
	    	{
                $f =$_POST['fn'.$i.''];
                 ...
                 $query ="DELETE FROM ac_year WHERE year ='".$f."' AND dep_id='".$user_id."'";
	   
	             $result =mysql_query($query);
	             if($result)
	             {
	                echo "<script type='text/javascript'>alert('Delete successfully');window.location = \"dept_hd_academic_year.php\"</script>";
	             ...
	             else
	             {
	             	...
	             	echo "<script type='text/javascript'>alert('Delete is faild');window.location = \"dept_hd_academic_year.php\"</script>";
   ...
   echo "<tr>";
    ...
    if(isset($_POST['addbtn']))
    {
        ...
        else
        {
			...
			$query = "INSERT INTO `ac_year`(`year`, `dep_id`) VALUES ('$f' ,'$user_id')";
	   
	        $result =mysql_query($query);
	         if(!$result)
	             {
	          
	             	echo "<script type='text/javascript'>alert('Insert is faild');window.location = \"dept_hd_academic_year.php\"</script>";
	             ...
	             else
	             {
	             	...
	             	echo "<script type='text/javascript'>alert('Insert successfully');window.location = \"dept_hd_academic_year.php\"</script>";
