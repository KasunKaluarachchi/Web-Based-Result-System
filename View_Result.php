				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active"><h4>Level-1S/1G</h4></li>
						</ul><!-- /.breadcrumb -->
	...
	if($_POST["hdnCmd"] == "Add")
{
	...
	$strSQL = "INSERT INTO assign_lecturer ";
...
{
	$strSQL = "UPDATE add_lecturer SET ";
...
if($_GET["Action"] == "Del")
{
	$strSQL = "DELETE FROM assign_lecturer ";
...
$strSQL = "SELECT * FROM view_result";
...
<table id="dynamic-table" class="table table-striped table-bordered table-hover">
  ...
  <tr>
    <th width="20"> <div align="center">Student ID</div></th>
    <th width="20"> <div align="center">Course ID</div></th>
	<th width="20"> <div align="center">Index Number</div></th>
    <th width="20"> <div align="center">Attempt</div></th>
	<th width="20"> <div align="center">Accademic Year</div></th>
    <th width="20"> <div align="center">Final Mark</div></th>
...
?>
  ...
  ?>
  <tr>
    <td><div align="center"><?php echo $objResult["stu_id"];?></div></td>
    <td><?php echo $objResult["course_id"];?></td>
	<td><?php echo $objResult["index_no"];?></td>
	<td><?php echo $objResult["attempt"];?></td>
	<td><?php echo $objResult["ac_year"];?></td>
	<td><?php echo $objResult["final_mark"];?></td>
...
?>
  <tr>
    ...
    <td colspan="2" align="right"><div align="center">
      <input name="btnAdd"  button class="btn btn-xs btn-info" size="2"
