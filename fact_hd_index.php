...
<table id="simple-table" class="table  table-bordered table-hover">
  ...
  <tr>
   ...
   <th width="6000"> <div align="center">Departmnet Name</div></th>
...
echo "<td>";
		...
		if(isset($_POST['updatebtn'.$i.'']))
	    {
               ...
               $f =$_POST['fn'.$i.''];
                ...
                $query ="UPDATE add_course SET coursename ='$f'  WHERE courseid ='$r'";
	             ...
	             if(!$result)
	             {
	             	 ...
	             	 echo "<script type='text/javascript'>alert('Update failed');window.location = \"fact_hd_index.php\"</script>";
	             }
	             else
	             {
	             	 echo "<script type='text/javascript'>alert('Update successfully');window.location = \"fact_hd_index.php\"</script>";   	
			...
			echo "<script type='text/javascript'>alert('Select the check box');window.location = \"fact_hd_index.php\"</script>";
	    	...
	    	if(isset($_POST['check-all'.$i.'']))
	    	{
                $f =$_POST['fn'.$i.''];
	             ...
	             if($result)
	             {
					...
					echo "<script type='text/javascript'>alert('Delete successfully');window.location = \"fact_hd_index.php\"</script>";
	             ...
	             else
	             {
	             	...
	             	echo "<script type='text/javascript'>alert('Delete is faild');window.location = \"fact_hd_index.php\"</script>";
	         ...
	         if(!$result)
	             {
	             	...
	             	echo "<script type='text/javascript'>alert('Insert is faild');window.location = \"fact_hd_index.php\"</script>";
	             ...
	             else
	             {
	             	...
	             	echo "<script type='text/javascript'>alert('Insert successfully');window.location = \"fact_hd_index.php\"</script>";
