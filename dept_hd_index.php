...
echo "<td>";
		...
		if(isset($_POST['updatebtn'.$i.'']))
	    {
               ...
               $f =$_POST['fn1'.$i.''];
                ...
                $query ="UPDATE add_course SET 	coursename ='$f',couseid ='$r' WHERE id ='$id'";
	             ...
	             if(!$result)
	             {
	             	 ...
	             	 echo "<script type='text/javascript'>alert('Update failed');window.location = \"dept_hd_index.php\"</script>";
	             }
	             else
	             {
	             	 echo "<script type='text/javascript'>alert('Update successfully');window.location = \"dept_hd_index.php\"</script>";   	
			...
			echo "<script type='text/javascript'>alert('Select the check box');window.location = \"dept_hd_index.php\"</script>";
